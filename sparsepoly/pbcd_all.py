...
@njit
def _update(p_j, j, indices, data, n_nz, y, y_pred, loss, lams,
            beta, gamma, eta, A, regularizer, grad,
            inv_step_sizes):
...
@njit
def _pbcd_epoch(P, X, y, y_pred, lams, beta, gamma, eta,
                regularizer, loss, A, grad, inv_step_sizes,
    ...
    for j in indices_feature:
        ...
        p_j_old[:] = P[j]
        _update(P[j], j, indices, data, n_nz, y, y_pred, loss, lams,
                beta, gamma, eta, A, regularizer, grad, inv_step_sizes)
